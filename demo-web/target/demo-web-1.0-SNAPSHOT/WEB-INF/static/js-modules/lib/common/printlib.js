define(['nativelib'], function (nativelib) {
    ...
    function Printer() {
        ...
        const lodopfun = function (opt) {
            ...
            if (opt.preview == 1) {
                LODOP.SET_PREVIEW_WINDOW(1, 2, 1, 0, 0, "预览查看.开始打印");
                ShowPreview();
                LODOP.PREVIEW();
    ...
    function ShowPreview() {
        if (nativelib && nativelib.ipc) {
            let cmd = {cmd: "showpreviewtop", title: "预览查看"}
            nativelib.ipc.send('client-message', cmd);
        }
    }
    ...
    window.CPRINTER = (function () {
        ...
        if (typeof LODOP === "undefined") {
            ...
            if (!LODOP) {
                ...
                oscript.src = "http://emis.wdhis.wd:8000/CLodopfuncs.js?priority=1";
